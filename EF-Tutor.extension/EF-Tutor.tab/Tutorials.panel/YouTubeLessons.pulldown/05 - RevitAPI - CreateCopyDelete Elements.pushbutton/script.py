...
#     wall = Wall.Create(doc, curve, active_level.Id, False)
    ...
    #==================================================
    # ARGUMENTS
    host_wall = doc.GetElement(ElementId(301792))
    ...
    print(window_type.IsActive)
    
    if window_type.IsActive == 0:
    ...
    # # CREATE A WINDOW
    window = doc.Create.NewFamilyInstance(pt_mid, window_type, host_wall,active_level, StructuralType.NonStructural)
